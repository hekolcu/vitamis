...
namespace VitamisAPI.Migrations
{
    ...
    [Migration("20240501111632_AdviseeDietitianRelation")]
    partial class AdviseeDietitianRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VitamisAPI.Data.Tracking.AdviseeDietitianRelation", b =>
                {
                    ...
                    b.Property<int>("AdviseeDietitianRelationId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AdviseeId", "DietitianId");

                    b.HasIndex("DietitianId");

                    b.ToTable("AdviseeDietitianRelations");
                });
            ...
            modelBuilder.Entity("VitamisAPI.Data.Tracking.AdviseeDietitianRelation", b =>
                {
                    b.HasOne("VitamisAPI.Data.User", "Advisee")
                        .WithMany()
                        .HasForeignKey("AdviseeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VitamisAPI.Data.User", "Dietitian")
                        .WithMany()
